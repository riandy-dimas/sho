...
class MyWatchFace : CanvasWatchFaceService() {
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        private fun initializeBackground() {
            ...
            mBackgroundBitmap = BitmapFactory.decodeResource(resources, R.drawable.carpet)
        ...
        override fun onSurfaceChanged(holder: SurfaceHolder, format: Int, width: Int, height: Int) {
            ...
            var baseLength = mCenterX

            /*
             * Calculate lengths of different hands based on watch screen size.
             */
            mSecondHandLength = (baseLength * 0.875).toFloat()
            sMinuteHandLength = (baseLength * 0.75).toFloat()
            sHourHandLength = (baseLength * 0.5).toFloat()
